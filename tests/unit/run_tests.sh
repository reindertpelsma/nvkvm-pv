...
ALL_BINARIES="test_dispatch test_frontend test_handle test_isolate test_tables test_open_scm test_ctrl_gate test_uvm_va_gate test_nvkms_allowlist test_stub_ptr_sanitize mock_stub"
