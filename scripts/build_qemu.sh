...
# upstream QEMU is seven patch files in patches/, applied with `git apply`;
...
#
# Everything nvkvm changes in *upstream* QEMU lives in patches/ as seven
# ordinary patch files.  "What does this do to my QEMU?" is therefore answered
# by reading seven diffs, not by reading this script and mentally executing the
